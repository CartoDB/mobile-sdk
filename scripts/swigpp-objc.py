...
parser.add_argument('--cppdir', dest='cppDir', default='../all/native;../extensions/all/native;../ios/native', help='directories containing C++ headers')
...
parser.add_argument('--sourcedir', dest='sourceDir', default='../all/modules;../extensions/all/modules;../ios/modules', help='input directories containing subdirectories of Swig wrappers')
