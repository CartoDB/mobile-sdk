...
%attributestring(carto::BalloonPopupStyleBuilder, std::string, TitleField, getTitleField, setTitleField)
...
%attributestring(carto::BalloonPopupStyleBuilder, std::string, DescriptionField, getDescriptionField, setDescriptionField)
