...
%attribute(carto::TomTomOnlineGeocodingService, bool, Autocomplete, isAutocomplete, setAutocomplete)
%attributestring(carto::TomTomOnlineGeocodingService, std::string, Language, getLanguage, setLanguage)
