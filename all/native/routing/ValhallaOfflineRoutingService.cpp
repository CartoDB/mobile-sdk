...
namespace valhalla { namespace thor {
    ...
    thor_worker_t::thor_worker_t(const std::string& path, const std::string& costing) : reader(std::make_shared<baldr::GraphTileMBTStorage>(path), make_reader_config(path)), costing(costing) {
