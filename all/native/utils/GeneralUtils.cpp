...
namespace carto {
    ...
    std::vector<std::string>& GeneralUtils::Split(const std::string& s, char delim, std::vector<std::string>& elems) {
    ...
    std::vector<std::string> GeneralUtils::Split(const std::string& s, char delim) {
