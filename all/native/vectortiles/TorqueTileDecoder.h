...
namespace carto {
    ...
    public:
        ...
        virtual std::vector<std::shared_ptr<TileFeature> > decodeFeatures(const vt::TileId& tile, const std::shared_ptr<BinaryData>& tileData, const MapBounds& tileBounds) const;
