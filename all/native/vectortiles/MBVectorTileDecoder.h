...
namespace carto {
    ...
    public:
        ...
        virtual std::shared_ptr<Feature> decodeFeature(long long id, const vt::TileId& tile, const std::shared_ptr<BinaryData>& tileData, const MapBounds& tileBounds) const;
