...
namespace carto { namespace mvt {
    void PolygonSymbolizer::build(const FeatureCollection& featureCollection, const SymbolizerContext& symbolizerContext, const ExpressionContext& exprContext, vt::TileLayerBuilder& layerBuilder) {
        ...
        vt::PolygonStyle style(compOp, vt::blendColor(_fill, _fillOpacity), std::shared_ptr<vt::BitmapPattern>(), _geometryTransform);
